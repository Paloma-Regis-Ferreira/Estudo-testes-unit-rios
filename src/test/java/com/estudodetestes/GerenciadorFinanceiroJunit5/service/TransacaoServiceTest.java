...
//anotação definida com nome de metodo estatico definido na propria classe que vai verificar se as condições pro teste serem realizadas são verdadeiras ou não
//@EnabledIf(value = "isHoraValida")
//@DisabledIf -> oposto do enabledIf
