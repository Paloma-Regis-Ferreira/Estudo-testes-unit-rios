    ...
    stages {
        ...
        stage('Test and Coverage') {
            steps {
                ...
                sh 'mvn clean test jacoco:report -Djacoco.excludes=com/estudodetestes/GerenciadorFinanceiroJunit5/barriga/**,com/estudodetestes/GerenciadorFinanceiroJunit5/exceptions/**,com/estudodetestes/GerenciadorFinanceiroJunit5/infra/**'
            }
        }
